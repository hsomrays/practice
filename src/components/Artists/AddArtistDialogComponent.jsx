...
const AddArtistDialogComponent = ({ onClose }) => {
  ...
  function validateForm() {
    ...
    if (!artistName.trim()) {
      errorsCopy.artistName = 'Artist Name is required';
      valid = false;
    } else {
      ...
      <div className="modal-dialog">
        <div className="modal-content">
          <div className="modal-header">
            <h5 className="modal-title text">Add Artist</h5>
          </div>
...
export default AddArtistDialogComponent;